...
<head>
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="post" action="signup.php">
                 <div class="control-group normal_text"> <h3>Sign up and get to work</h3></div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span>
                            <input type="password" placeholder="Confirm Password" name="urepass" required />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                    ...
                    <span  style="margin-left: 20px;"><button type="submit" name="signup" class="btn btn-success">Signup</button></span>
                </div>
