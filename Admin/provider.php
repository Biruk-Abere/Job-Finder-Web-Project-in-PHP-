  ...
  <ul>
   ...
   <!--  <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>Manage JobFinder</span></a> </li> -->
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th"></i> <span>Manage JobProvider</span> <span class="label label-important">3</span></a>
      <ul>
        <li><a href="form-common.html">Job Providers</a></li>
        <li><a href="form-validation.html">Form with Validation</a></li>
        <li><a href="form-wizard.html">Form with Wizard</a></li>
      </ul>
    </li>
      ...
      <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              	<?php  
                  $sql = "SELECT * FROM company_reg WHERE status ='pending'";
                ...
                <tr class="gradeX">
                 ...
                 <td class="center"><a class="btn btn-info" href="ActivateProvider.php?active=<?php echo $row['companyId'] ?>">Activate</a></td>
                 <td class="center"><a class="btn btn-danger" href="DeleteProvider.php?delete=<?php echo $row['companyId'] ?>">Delete</a></td>
                </tr>
                <?php 
                 endwhile;
             endif;
        ...
        <br>
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
              	<?php  
                  $sql2 = "SELECT * FROM company_reg WHERE status ='confirm'";
                ...
                <tr class="gradeX">
                  ...
                  <td><?php echo $row2['companyEmail']; ?></td>
                  <td class="center"><a class="btn btn-danger" href="DeactivateProvider.php?deactive=<?php echo $row2['companyId']; ?>">Deactivate</a></td>
                  <td class="center"><a class="btn btn-info" href="DeleteProvider.php?delete=<?php echo $row2['companyId']; ?>">Delete</a></td>
                </tr>
                 <?php 
                 endwhile;
             endif;
