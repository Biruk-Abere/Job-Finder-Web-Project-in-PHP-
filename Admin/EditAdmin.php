    ...
    <div class="row-fluid">
      <div class="span12">
        <div class="widget-box">
          ...
          <?php 
           $id = $_GET['edit'];
           $sql = "SELECT * FROM admin_reg WHERE adminId = '$id'";
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" method="post" action="UpdateAdmin.php">
              <div id="form-wizard-1" class="step">
                 <input type="hidden" name="adminid" value="<?php echo  $id;?>">
                <div class="control-group">
                  <label class="control-label">Username</label>
                  <div class="controls">
                    <input id="username" type="text" name="username"  value="<?php echo $name; ?>" />
