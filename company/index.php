...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
   ...
   <li class="active"><a href="post.php"><i class="icon icon-home"></i> <span>Post a Job</span></a> </li>
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="post.php"> <i class="icon-inbox"></i><span class="label label-success">101</span>Post a Job</a> </li>
