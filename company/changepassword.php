...
<?php 
 if (isset($_POST['submit'])) {
    ...
    $id = $_SESSION['companyId'];
 	...
 	if ($result) {
 		...
 		if ($resultcheck>0) {
 			...
 			while ($row= mysqli_fetch_assoc($result)) {
 				# code...
 				$password_verify = password_verify($oldpassword , $row['companyPassword']);
 				if ($password_verify==false) {
 					# code...
 					echo '<script type="text/javascript">alert("Incorrect password"); window.lcoation=\'Company/changepassword.php\';</script>';
 					exit();
 	...
 	$sql2 ="UPDATE company_reg SET companyPassword='".$password_hash."'where companyId='".$id."'";
            ...
            header("Location: index.php");
                      ...
                      echo '<script type="text/javascript">alert("Password Not Changed"); window.lcoation=\'Company/index.php\';</script>';
 					  exit();
 					}
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" method="post" action="changepassword.php">
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  <label class="control-label">Old Password</label>
                  <div class="controls">
                    <input id="pass" type="password" name="oldpass" />
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input id="pass" type="password" name="newpass" />
                  </div>
                </div>
